...
This section outlines the steps to install the Free Gifts for Woocoommerce Plugin.
...
= 1.0.2 (2025-07-11) =
* `[Fixed]` Rules cached wasn't cleared upon save resulting in eligible gift rules not showing

= 1.0.1 (2025-06-25) =
* `[Fixed]` Save notice missing after successful save

= 1.0.0  (2025-04-5) =
* Release Date: Monday, 5 April 2025*